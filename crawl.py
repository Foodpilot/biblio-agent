...
#         )
#         result = await crawler.arun(
#             url="https://www.researchgate.net/profile/Julien-Berthaud/publication/32986463_Botanical_Classification_of_Coffee/links/00b7d53564a7232f79000000/Botanical-Classification-of-Coffee.pdf",
#             config=config,
#         )
